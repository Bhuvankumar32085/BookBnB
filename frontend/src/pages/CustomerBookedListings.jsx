...
const CustomerBookedListings = () => {
  ...
  if (!loggedUser) {
    return (
      <div className="text-center py-10 text-gray-600 text-lg">
        🚪 Please login to see Customer Booking.
      </div>
    );
  }
  ...
  if (customerBookings.length === 0) {
    return (
      <div className="text-center py-10 text-gray-600 text-lg">
        🏡 You haven’t posted any Customer Bookings yet.
      </div>
    );
  }
...
export default CustomerBookedListings;
